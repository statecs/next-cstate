...
export const FloatingHeader = memo<FloatingHeaderProps>(({ scrollTitle, title, goBackLink, children }) => {
  ...
  return (
    <header className="sticky inset-x-0 top-0 z-10 mx-auto flex h-12 w-full shrink-0 items-center overflow-hidden border-b bg-white dark:bg-custom-light-gray dark:text-white text-sm font-medium lg:hidden">
