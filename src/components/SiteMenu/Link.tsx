        ...
        >
            <span
                className={clsx('underline-offset-4 transition duration-200 hover:duration-500', {
                    'text-black dark:text-white group-hover:text-black group-hover:underline group-focus:text-black group-focus:underline dark:hover:text-white dark:group-hover:text-white dark:group-focus:text-white':
                        !isActive,
