    ...
    <section className="w-full max-w-6xl mx-auto px-4 py-16 animate-fadeIn" style={{ animationDelay: '400ms' }}>
      ...
      <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
        {companies.map((company) => (
          <div
            key={company.name}
            className="aspect-square rounded-xl border border-gray-800 dark:border-gray-700 flex items-center justify-center bg-gray-900/50 dark:bg-gray-800/50 hover:bg-gray-800 dark:hover:bg-gray-700 hover:border-gray-700 dark:hover:border-gray-600 transition-all duration-300 hover:scale-105 group"
          >
