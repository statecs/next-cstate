...
const NotFound = () => (
    <div className="flex h-[calc(100vh-60px)] h-screen flex-grow border-spacing-4 items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-800">
